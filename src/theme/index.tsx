...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    text5: darkMode ? '#333333' : 'rgba(0,0,0,0.4)',

    // backgrounds / greys
    bg1: darkMode ? '#000000' : '#FFFFFF',
    bg2: darkMode ? '#191919' : '#F7F8FA',
    bg3: darkMode ? '#252525' : 'rgba(37, 37, 37, 0.4)',
    bg4: darkMode ? '#303030' : '#CED0D9',
    bg5: darkMode ? '#A1A1A1' : '#888D9B',

    //specialty colors
    mainBG: '#F2F5FA',
    modalBG: darkMode ? 'rgba(0,0,0,.7)' : '#FFFFFF',
    advancedBG: darkMode ? 'rgba(0,0,0,0.1)' : 'rgba(0,0,0,0.7)',

    //primary colors
    primary1: darkMode ? '#B2F355' : '#31B047',
    primary2: darkMode ? '#B2F355' : '#129026',
...
export const TYPE = {
  ...
  smallGray(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={12} color={'bg3'} {...props} />
  },
